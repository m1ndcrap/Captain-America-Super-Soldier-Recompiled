...
if(REXSDK_DIR)
    ...
    if(REXSDK_VERSION)
        ...
        find_package(rexglue 0.4.0 QUIET CONFIG)
    endif()
...
# Codegen target - run 'cmake --build . --target captainamericasupersoldier_codegen'
add_custom_target(captainamericasupersoldier_codegen
    COMMAND $<TARGET_FILE:rex::rexglue> codegen ${CMAKE_CURRENT_SOURCE_DIR}/captainamericasupersoldier_config.toml
    WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
    COMMENT "Generating recompiled code for captainamericasupersoldier"
    VERBATIM
)
